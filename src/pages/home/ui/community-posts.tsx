        ...
        <div className="flex gap-[11px] py-[10px] w-full h-[314px] overflow-auto items-start">
          ...
          <div className="w-full flex flex-col gap-[7px]">
            <div className="flex gap-2 items-center">
              <Badge theme="mini">네이버</Badge>
              <Text fz={16} fw={600} c="var(--mantine-color-dark-2)">
                이번 케스파컵 너무 재밌다
              </Text>
            </div>
            <div className="flex items-center">
              <Eye />
              <Text fz={16} fw={600} c="var(--mantine-color-dark-2)" ml={4}>
                112
              </Text>
              <div className="bg-[var(--mantine-color-dark-2)] w-1 h-1 rounded-full mx-2"></div>
              <ThumbUp />
              <Text fz={16} fw={600} c="var(--mantine-color-dark-2)" ml={4}>
                45
              </Text>
