  ...
  return (
    <>
      <div className="w-full flex flex-col items-center">
        ...
        <div className="w-[291px] sm:w-[549px] md:w-[846px] justify-center sm:justify-stretch mt-[30px] sm:mt-[19px] px-5 flex items-center gap-[19px]">
          <div className="flex items-center gap-2 shrink-0">
            ...
            <div className="relative shrink-0">
              ...
              />
              {isInfoOpen && (
                <div className="absolute top-full -left-[120px] sm:left-0 mt-2 flex flex-col items-center justify-center p-6 gap-[6px] w-[291px] sm:w-[630px] bg-(--nar-bg-secondary) shadow-[0px_4px_12px_0px_#0000000F] rounded-[24px] z-6">
                  <div className="flex flex-col items-center justify-center gap-[6px]">
                    <Text c="var(--nar-text-2)" fw={400} fz={16}>
                      나르지지는 여러분이 가장 쉽고 빠르게 데이터를 찾을 수
                      있도록 설계되었습니다.
                    </Text>
                  </div>
          ...
          <div className="flex items-center gap-6 whitespace-nowrap">
            <Text c="var(--nar-text-3)" fw={400} fz={{ base: 14, md: 16 }}>
              T1 VS Gen.G
            </Text>
            <Text c="var(--nar-text-3)" fw={400} fz={{ base: 14, md: 16 }}>
              ㅍㅇㅋ
